    ...
    if(r == 0){
        if(dev == nullptr){
            ...
            if(ci == 0){
                ...
                int A = (idBuffer[0]) + (idBuffer[1]<<8) + (idBuffer[2]<<16) + (idBuffer[3]<<24);
                int B = (idBuffer[4]) + (idBuffer[5]<<8) + (idBuffer[6]<<16) + (idBuffer[7]<<24);
                int C = (idBuffer[8]) + (idBuffer[9]<<8) + (idBuffer[10]<<16) + (idBuffer[11]<<24);
                ...
                device->dID_label->setText("Device ID: 0x"+HexAA+",0x"+HexBB+",0x"+HexCC.right(8));
            }
        }
